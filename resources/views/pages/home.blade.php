...
@section('content')
    <section>
        ...
        <p>
            ...
            I can use databases, spreadsheets and word processors. I also have considerable experience with image
            manipulation software and some experience creating vector graphics.
        </p>
        <h3>Work Experience</h3>
        <h4>Mobiloo</h4>
        <p>
            I have been working with the company <a href="https://mobiloo.org.uk" target="_blank">Mobiloo</a> for
            several years building a Laravel app. I arrived when the project was underway and have been the sole
            contributor since then improving both the product and the code quality.
        </p>
        <h4>Other</h4>
        <p>
